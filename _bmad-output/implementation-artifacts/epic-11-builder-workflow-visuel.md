# Epic 11: Builder de Workflow Visuel avec Branches Conditionnelles et Retry
...
### Story 11.1: Séparation des boutons "Nouvelle action" et "Nouveau workflow"
...
### Story 11.2: Modèle de données pour workflows avec branches et retry
...
### Story 11.3: Moteur d'exécution avec support des branches conditionnelles
...
### Story 11.4: Moteur de retry avec backoff exponentiel
...
### Story 11.5: Interface de builder visuel de workflow
...
### Story 11.6: Configuration des options de retry dans le builder visuel
...
### Story 11.7: Visualisation et validation des chemins dans le builder visuel
...
### Story 11.8: Export/Import de workflows depuis le builder visuel
...
**Note Story 11.1** : Cette story peut être implémentée indépendamment et avant les autres stories de cet épic. Elle améliore l'UX de base de création d'actions/workflows.
