...
- **Migration effectuée :** Les alias DBOPSProfilePermission et IsDBAOrDBOPS ont été supprimés. Utiliser AdminProfilePermission et IsAdminUser exclusivement.
...
- PAGE_DBA_API_URL supprimé, utiliser uniquement PAGE_ONCALL_API_URL.
- L'alias page_dba a été supprimé du dispatch.
