...
class AuditActionType(str, Enum):
    ...
    # Scheduled execution (Story 11.3, AC6; Story 11.6; Story 11.7)
    SCHEDULED_EXECUTION_CREATED = "SCHEDULED_EXECUTION_CREATED"
    SCHEDULED_EXECUTION_CANCELLED = "SCHEDULED_EXECUTION_CANCELLED"
    # Recurring patterns (Story 11.7, AC11)
    SCHEDULED_EXECUTION_RECURRING_CREATED = "SCHEDULED_EXECUTION_RECURRING_CREATED"
    SCHEDULED_EXECUTION_RECURRING_DISABLED = "SCHEDULED_EXECUTION_RECURRING_DISABLED"
    SCHEDULED_EXECUTION_RECURRING_ENABLED = "SCHEDULED_EXECUTION_RECURRING_ENABLED"
    # External scheduler (Story 11.10, AC8)
    SCHEDULED_EXECUTION_EXECUTED = "SCHEDULED_EXECUTION_EXECUTED"
