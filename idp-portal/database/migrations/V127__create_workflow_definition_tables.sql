...
CREATE SEQUENCE SEQ_WORKFLOW_DEFINITIONS START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE WORKFLOW_DEFINITIONS (
    ID              NUMBER DEFAULT SEQ_WORKFLOW_DEFINITIONS.NEXTVAL PRIMARY KEY,
    ACTION_ID       NUMBER,
...
CREATE SEQUENCE SEQ_WORKFLOW_STEPS START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE WORKFLOW_STEPS (
    ID                          NUMBER DEFAULT SEQ_WORKFLOW_STEPS.NEXTVAL PRIMARY KEY,
...
CREATE SEQUENCE SEQ_WORKFLOW_STEP_EDGES START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE TABLE WORKFLOW_STEP_EDGES (
    ID              NUMBER DEFAULT SEQ_WORKFLOW_STEP_EDGES.NEXTVAL PRIMARY KEY,
