-- V079: Add ACTION_DISABLED_INTEGRATION_DELETED to AUDIT_LOG ACTION_TYPE
-- Aligns Oracle CHECK with Django AuditActionType (core/models.py).
-- Used when an integration is deleted and linked actions are disabled (IntegrationService).
...
COMMENT ON COLUMN AUDIT_LOG.ACTION_TYPE IS 'V079: ACTION_DISABLED_INTEGRATION_DELETED added for integration-deletion audit trail';
