-- Story 25.3: Add gate evaluation audit action types
-- EXECUTION_STEP_GATE_SATISFIED: gate conditions met, step transitions WAITING → RUNNING
-- EXECUTION_STEP_GATE_TIMEOUT: gate timeout expired, step transitions to FAILED/SKIPPED
-- Also adds EXECUTION_STEP_WAITING from Story 25.2 (was missing from V068)
