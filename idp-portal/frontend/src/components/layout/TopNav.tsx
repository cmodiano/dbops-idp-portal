...
export function TopNav() {
  ...
  const tabs: NavigationTabKey[] = user?.navigation_tabs ?? [];
  const navigationTabs: NavigationTabKey[] = user?.is_auditor && !tabs.includes('audit')
    ? [...tabs, 'audit' as NavigationTabKey]
    : tabs;
