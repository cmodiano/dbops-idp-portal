# Generated manually for Story 59.6 SEC-6 — adds AUTH_DEV_BYPASS_LOGIN to AuditActionType choices
# Code review fix: AUTH_DEV_BYPASS_LOGIN placed after SERVICE_LOGIN (matches model order);
# WORKFLOW_STEP_SCHEDULE_CREATED (Story 57.15) added — was missing from 0006, corrected here.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0006_add_integration_health_check_tested_audit_type"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    # Story 57.15: Workflow schedule step audit type (missing from 0006, added here)
