# Generated manually for story 66-17 review — adds API_KEY_CREATED and API_KEY_REVOKED to AuditActionType
# Rationale: Creating and revoking API keys are security-critical operations (SOC1 compliance).
# These operations must be traceable in the audit log to satisfy NFR8 (immutable audit trail).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0009_add_scheduled_execution_recurring_enabled_audit_type"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("CONFIG_SYNC_REFERENCE_IMPORT", "Config Sync - Reference Data Import"),
                    ("CONFIG_SYNC_TAGS_IMPORT", "Config Sync - Tags Import"),
                    ("CONFIG_SYNC_FEATURE_FLAGS_IMPORT", "Config Sync - Feature Flags Import"),
                    (
                        "CONFIG_SYNC_INTEGRATION_TYPE_IMPORT",
                        "Config Sync - Integration Type Import",
                    ),
                    ("CONFIG_SYNC_INTEGRATION_IMPORT", "Config Sync - Integration Import"),
                    ("CONFIG_SYNC_POLICY_IMPORT", "Config Sync - Policy Import"),
                    ("CONFIG_SYNC_ACTION_IMPORT", "Config Sync - Action Import"),
                ],
