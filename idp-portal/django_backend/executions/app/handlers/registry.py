"""
StepHandlerRegistry — Story 85.4 — Relocalisation vers app/handlers/.

Registre centralisé des handlers de step types (Story 84.1).
...
from executions.app.handlers.service_call_handler import ServiceCallHandler
